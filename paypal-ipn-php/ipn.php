...
class PayPal_IPN {
    ...
    function ipn_response($request) {
        ...
        if ($this->ipn($ipn_data)) {
            ...
            if ($ipn_data == true) {
                ...
                //mail($to, "NORMAL IPN RESULT YAY MONEY!", $msg, "From: noreply@projectguerra.000webhostapp.com");
                //sendEmail($to, $sub, $msg);
                
                $this->insert_data($msg);    
            }
    ...
    function insert_data($request) {
        ...
        $query = "INSERT INTO ipn_data_tbl (txn_id,userId,payer_email,amount,payment_status,payment_date) VALUES ('$txn_id','$custom','$payer_email','$amount','$payment_status','$payment_date')";
